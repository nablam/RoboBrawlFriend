...
public sealed partial class NdiReceiver : MonoBehaviour
{
    ...
    public string targetMaterialProperty
      { get => _targetMaterialProperty;
        ...
        [SerializeField] bool _allowRendering = false;
        public bool AllowRendering { get => _allowRendering; set => _allowRendering = value; }


    


        [SerializeField] bool _allowBlit = false;
        public bool AllowBlit { get => _allowBlit; set => _allowBlit = value; }
        #endregion
