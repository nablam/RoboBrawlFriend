...
[CustomEditor(typeof(NdiReceiver),true)]
...
#pragma warning disable CS0649
    ...
    AutoProperty _targetMaterialProperty;
     public bool e_allowRendering;
     
        public bool e_allowBlit;
#pragma warning restore
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(_targetRenderer);
            ...
            e_allowRendering= base.serializedObject.FindProperty("_allowRendering").boolValue;

            e_allowRendering = EditorGUILayout.Toggle("do REN", e_allowRendering);

            if (e_allowRendering)
            {
                base.serializedObject.FindProperty("_allowRendering").boolValue = true;

            }
            else {
                base.serializedObject.FindProperty("_allowRendering").boolValue = false;
            }
            ...
            e_allowBlit = base.serializedObject.FindProperty("_allowBlit").boolValue;
            e_allowBlit = EditorGUILayout.Toggle("do blit", e_allowBlit);

            if (e_allowBlit)
            {
                base.serializedObject.FindProperty("_allowBlit").boolValue = true;

            }
            else
            {
                base.serializedObject.FindProperty("_allowBlit").boolValue = false;
            }

            //EditorGUILayout.Toggle(e_allowRendering,"ren");
            //EditorGUILayout.Toggle(e_allowsetmaintext,"tex");
            ////EditorGUILayout.Toggle(_allowBlit);
